package com.laisbaumgratz.beerorcoffee.adapters;

/**
 * Code imported from https://github.com/doomtrooper/GoogleAutoCompleteWithRecyclerView
...
import com.laisbaumgratz.beerorcoffee.R;
...
public class PlacesAutoCompleteAdapter
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        mPredictionHolder.mPredictionAddress1.setText(mResultList.get(i).description1);
        mPredictionHolder.mPredictionAddress2.setText(mResultList.get(i).description2);
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder {
        private TextView mPredictionAddress1, mPredictionAddress2;
        private RelativeLayout mRow;
        public PredictionHolder(View itemView) {
            super(itemView);
            mPredictionAddress1 = (TextView) itemView.findViewById(R.id.tv_search_address_1);
            mPredictionAddress2 = (TextView) itemView.findViewById(R.id.tv_search_address_2);
            mRow = (RelativeLayout) itemView.findViewById(R.id.rl_search_row);
        }
    }
    ...
    public class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId, CharSequence description1, CharSequence description2) {
        ...
        public String toString() {
            return description1.toString() + " - " + description2.toString();
        }
    }
}